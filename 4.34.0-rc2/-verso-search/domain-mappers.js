 ...
 * @type {DomainMapper}
 */
const UsersGuide_DOT_Releases_DOT_entry = {
    dataToSearchables:
      (domainData) =>
          Object.entries(domainData.contents).map(([key, value]) => ({
 ...
 * @type {DomainMapper}
 */
const UsersGuide_DOT_Releases_DOT_version = {
    dataToSearchables:
      (domainData) =>
          Object.entries(domainData.contents).map(([key, value]) => ({
...
export const domainMappers = {"Verso.Genre.Manual.doc.suggestion":
  ...
  "UsersGuide.Releases.entry": UsersGuide_DOT_Releases_DOT_entry,
  ...
  "UsersGuide.Releases.version": UsersGuide_DOT_Releases_DOT_version,
