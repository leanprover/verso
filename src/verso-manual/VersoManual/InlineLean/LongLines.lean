...
Note: In the Manual genre, example code is rendered in a two-column layout, and long lines are
likely to be truncated in the rendered output.

Hint: The limit of this linter can be changed with the option `verso.code.warnLineLength`.
